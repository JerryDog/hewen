...
(function($) {
	...
	$.fn.prettyPhoto = function(pp_settings) {
		pp_settings = jQuery.extend({
			...
			theme: 'nitro_dark_rounded', /* light_rounded / dark_rounded / light_square / dark_square / facebook */
		...
		*/
		...
		function _insert_gallery(){
			if(isSet && settings.overlay_gallery && _getFileType(pp_images[set_position])=="image") {
				...
				navWidth = (settings.theme == "nitro_dark_rounded") ? 58 : 38; // Define the arrow width depending on the theme
